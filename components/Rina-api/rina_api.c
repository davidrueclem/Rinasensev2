                                                      ...
                                                      struct rinaFlowSpec_t *xFlowSpec)
{
    ...
    xPortId = xIpcMngrAllocatePortId();
...
void RINA_init(void)
{
    ...
    LOGI(TAG_RINA, "Initializing RINA Stack");

    /*Init the IpcManager*/
    if (!xIpcMngrInit())
    {
        LOGE(TAG_RINA, "IPC manager was not initialized properly");
    }
    /*Create and Init the RINA Stack*/
    if (!xIpcMngrInitRinaStack())
        LOGE(TAG_RINA, "RINA Stack was not initialized properly");
}
