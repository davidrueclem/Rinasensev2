#ifndef _COMPONENTS_RINA_MANAGER_INCLUDE_IPCP_INSTANCE_H
#define _COMPONENTS_RINA_MANAGER_INCLUDE_IPCP_INSTANCE_H
 ...
 */
    ...
    /* Defition of type of IPCP Instance */
    typedef enum TYPE_IPCP_INSTANCE
    {
        eShimWiFi = 0,  /*Shim WiFi instance*/
        eNormal = 1,    /*Normal instance*/
        eShim802154 = 2 /*Shim 802.15.4*/
    ...
    {
        ipcpInstanceId_t xId;              /*Id Instances manage by the IPCP Manager*/
        ipcpInstanceType_t xType;          /*Type of IPCP instance*/
        struct ipcpInstanceData_t *pxData; /*Data of each IPCP, data is defined in each type IPCP module*/
        struct ipcpInstanceOps_t *pxOps;   /*Generic Operations for each IPCP, operations are mapped in each IPCP module*/
        RsListItem_t xInstanceItem;        /*List item to be add in the IPCPs list which is maintenance by the IPCP manager*/
    };
...
#endif // _COMPONENTS_RINA_MANAGER_INCLUDE_IPCP_INSTANCE_H
